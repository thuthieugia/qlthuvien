	...
	<div class="header-title-content d-flex py-1 my-0" style="justify-content: space-between;">
		...
		<div class="justify-content-end">
			<ol class="d-flex col py-1 my-0 bg-transparent">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="index.php?page=list-categorys">Quản lý thể loại sách</a></li>
			...
			<div class="col-md-12 ">
				<div class="p-sm-4 bg-white rounded-sm shadow-sm">
					<div class="my-md-4 table-responsive">  
						<form name="" action="index.php?page=list-categorys&method=update" method="POST">
							<center>
								<h2>CẬP NHẬT THÔNG TIN THỂ LOẠI SÁCH</h2>
								<table border="1" class="table table-hover">
									<tr>
										<td>Mã số<span style="color: red;">*</span></td>
										<td><input type="text" name="id" size="20" value="<?php echo $result['0']['maTheLoai']; ?>" readonly/></td>
									</tr>
									<tr>
										<td>Tên thể loại<span style="color: red;">*</span></td>
										<td><input type="text" name="name" size="20" value="<?php echo $result['0']['tenTheLoai']; ?>" required /></td>
									</tr>
									<tr>
										<td>Ghi chú</td>
						...
						<div>
							<a href="index.php?page=list-categorys"><button class="btn btn-transparent text-dark" style="border:2px solid rgb(19, 236, 11)">Trở về</button></a>
						</div>
					</div>
				</div>
			</div>
