        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="p-sm-4 bg-white rounded-sm shadow-sm">
                    <div>
                        <div>
                            <a href="index.php?page=add-account"><button class="btn btn-transparent text-dark" style="border:2px solid rgb(19, 236, 11)">Thêm tài khoản</button></a>
                        </div>
                    </div>
                           ...
                           <tbody id="myTable">
                              ...
                              foreach ($result as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?page=update-account&method=edit&id=<?php echo $value['maCanBo'];?>">Sửa</a>|
                                        <a href="index.php?page=list-accounts&method=destroy&id=<?php echo $value['maCanBo'];?>" onclick ="return confirm('Bạn có chắc chắn muốn xóa tài khoản?')">Xóa</a>
                                    </td>
                                </tr>
                                <?php
                            }
