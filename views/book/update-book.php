<!-- breadcrumb -->
	<div class="header-title-content d-flex py-1 my-0" style="justify-content: space-between;">
		<div class="card-title">
			<i class="fas fa-user text-success mr-sm-4"></i> <a href="#downs" class=" text-decoration-none text-dark"><span class="font-weight-bold text-uppercase">Cập nhật sách</span> </a>
		</div>
		<div class="justify-content-end">
			<ol class="d-flex col py-1 my-0 bg-transparent">
				<li class="breadcrumb-item active" aria-current="page">Cập nhật sách</li>
			...
			<div class="col-md-12 ">
				<div class="p-sm-4 bg-white rounded-sm shadow-sm">
					<div class="my-md-4 table-responsive">  
						<form name="" action="index.php?page=list-books&method=update" method="POST" enctype="multipart/form-data">
							<center>
								<h2>CẬP NHẬP THÔNG TIN SÁCH</h2>
								<table border="1" class="table table-hover">
									<tr>
										<td>Mã sách<span style="color: red;">*</span></td>
										<td><input type="text" name="id" size="20" value="<?php echo $result['0']['maSach'] ?>" readonly  /></td>
									</tr>
									<tr>
										<td>Tên sách<span style="color: red;">*</span></td>
										<td><input type="text" name="name" size="20" value="<?php echo $result['0']['tenSach'] ?>" required  /></td>
									</tr>
									<tr>
										<td>Ảnh</td>
										<td><input type="file" name="avatar" size="20" /><?php 
                                    															$anh="assets/img/books/".$result['0']['anh'];
															                                    $anh="<img src='$anh' width='50px'>";
															                                    echo $anh;?></td>
									</tr>
									<tr>
										<td>Tác giả</td>
										<td><input type="text" name="author" size="20" value="<?php echo $result['0']['tenTacGia'] ?>" /></td>
									</tr>
									<tr>
										<td>Thể loại sách</td>
										<td>
											<select name="category">
												...
												?>
												<option value="<?php echo $value['maTheLoai'] ?>" <?php if ($value['maTheLoai'] ==$result['0']['maTheLoai'] ) {
									...
									<tr>
										...
										<td>
											<select name="NXB">
												...
												?>
												<option value="<?php echo $value['maNXB'] ?>" <?php if ($value['maNXB'] ==$result['0']['maNXB'] ) {
													echo 'selected = "selected"';
									...
									<tr>
										...
										<td>
											<select name="store">
												...
												?>
												<option value="<?php echo $value['maKho'] ?>" <?php if ($value['maKho'] ==$result['0']['maKho'] ) {
													echo 'selected = "selected"';
												}?>><?php echo $value['tenKho'] ?></option>
												<?php
													}
												?>
											</select>
									...
									<tr>
										<td>Số lượng</td>
										<td><input type="number" name="number" size="20" value="<?php echo $result['0']['soluong'] ?>"/></td>
									</tr>
									
									<tr>
										<td>Giá tiền</td>
										<td><input type="text" name="price" size="20"  value="<?php echo $result['0']['giaTien'] ?>"/></td>
									</tr>
