...
<div class="card-title">
	<i class="fas fa-user text-success mr-sm-4"></i> <a href="#downs" class=" text-decoration-none text-dark"><span class="font-weight-bold text-uppercase">Cập nhật thông tin trả sách</span> </a>
</div>
	...
	<div class="col-md-12 ">
		<div class="p-sm-4 bg-white rounded-sm shadow-sm">
			<div class="my-md-4 table-responsive">
				<form name="" action="index.php?page=list-return-books&method=update" method="POST">
					<center>
						<h2>CẬP NHẬT THÔNG TIN TRẢ</h2>
						<table border="1" class="table table-hover">
							...
							<tr>
								...
								<td><textarea name="status-return">
									<?php echo $result['0']['tinhTrangTra'];?>
								</textarea></td>
							</tr>
							<tr>
								<td>Hạn trả sách</td>
							...
							<tr>
								<td>Ngày sách</td>
								<td><input type="date" name="dateReturn" size="20" value="<?php echo $result['0']['ngayTra'];?>"/></td>
							</tr>
							<tr>
								<td>Thanh toán</td>
								<td><input type="text" name="price" size="20" value="<?php echo $result['0']['thanhToan'];?>"/></td>
							</tr>
							<tr>
								<td>Cán bộ thực hiện<span style="color: red;">*</span></td>
								<td><input type="number" name="memberID" value="<?php echo $result['0']['maCanBoTra'];?>" readonly></td>
							</tr>
							<tr>
								<td>Ghi chú</td>
